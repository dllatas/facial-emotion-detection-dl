...
NUM_CLASSES = 6
#NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 50000   64
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 3064
...
def distorted_inputs(data_dir, batch_size):
  ...
  print ('Filling queue with %d CK+ images before starting to train. This will take a few minutes.' % min_queue_examples)
